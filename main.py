...
def fill_out():
	...
	for line in bill_sponsors_csv:
		...
		# if attributes[5] == '"Charles W. Carrico':
		# 	print(line)
		# 	print(attributes[5])
...
# for line in featured_bills:
# 	attributes = line.strip().split(',')
# 	bill_ID = attributes[0]
# 	featured_bills.append(bill_id)
...
for bill_IDS, final_bill in bill_objects.items():
	lines = ""
	lines += str(final_bill.bill_number) + "," + str(final_bill.date) + "," + str(final_bill.primary_sponsor) + "," +  str(final_bill.sponsors_ID) + "," + str(final_bill.stages[0]) + "," + str(final_bill.stages[1]) + "," + str(final_bill.stages[2]) + "," + str(final_bill.stages[3]) + "," + str(final_bill.stages[4]) + "," + str(final_bill.significance) 
	output2.write(lines + "\n")
